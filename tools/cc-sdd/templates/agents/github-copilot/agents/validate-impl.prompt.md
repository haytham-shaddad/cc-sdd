...
- Use runCommands/runTests to run test commands (e.g., `npm test`, `pytest`)
...
- Use search/codebase to confirm file structure matches design
...
- **runCommands/runTests for tests**: Execute test commands to verify pass status
- **search for traceability**: Search codebase for requirement evidence
- **search/codebase for structure**: Verify file structure matches design
