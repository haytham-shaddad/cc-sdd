...
3. **Execute Gap Analysis**:
   ...
   - Analyze existing codebase using search tools
   - Use web/fetch for external dependency research if needed
...
- **search extensively**: Search codebase for patterns, conventions, and integration points
- **web/fetch**: Research external dependencies and best practices when needed
