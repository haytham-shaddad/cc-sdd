...
Use search/codebase to expand file patterns, then read all files:
- Find `{{KIRO_DIR}}/steering/*.md` to get all steering files
- Read each file from results
...
2. **Execute Appropriate Discovery Process**:
   ...
   **For Complex/New Features**:
   ...
   - Conduct thorough research using web/fetch:
   ...
   **For Extensions**:
   ...
   - Use search to analyze existing codebase patterns
...
- **Latest Information**: Use web/fetch for external dependencies and best practices
...
- **Research when uncertain**: Use web/fetch for external dependencies, APIs, and latest best practices
- **Analyze existing code**: Use search to find patterns and integration points in codebase
