...
- For Sync mode:
  - Find `{{KIRO_DIR}}/steering/*.md` to get all existing steering files
...
2. Analyze codebase (JIT):
   - Use search/codebase for source files
...
- `search/codebase`: Find source/config files
- `edit/editFiles`: Read steering, docs, configs, write updates
- `search`: Search patterns
- Use search/codebase to analyze structure
