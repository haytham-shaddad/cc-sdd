...
- Find `{{KIRO_DIR}}/settings/templates/steering-custom/*.md` to find available templates
...
3. **Analyze codebase** (JIT) for relevant patterns:
   - Use search/codebase for related files
   - Read existing implementations
   - Use search for specific patterns
...
- **search/codebase**: Find related files for pattern analysis
- **edit/editFiles**: Load template, read existing code, write steering file
- **search**: Search for specific patterns
- Use search/codebase to understand relevant structure
